...
//            "242-Voltagegated_Sodium_Channels-6j8j_homepage-tn.png",
        ...
        "254-Cellulose_Synthase-6wlb_homepage-tn.png",
        "255-Cisplatin_and_DNA-1ckt_homepage-tn.png",
        "256-SARSCoV2_Spike_and_Antibodies-Spike_Antibodies_Homepage-tn.png",
        "257-Fetal_Hemoglobin-1fdh_homepage-tn.png",
        "258-Glucocorticoid_Receptor_and_Dexamethasone-1m2z_1glu_icon-tn.png",
        "259-Designed_Proteins_and_Citizen_Science-Foldit_homepage-tn.png",
        "260-6ahu_homepage-tn.png",
        "261-4uv3_homepage-tn.png",
        "262-1970s_homepage-tn.png",
        "263-6vz8_homepage-tn.png",
        "264-SWISSmodel_7kj2_homepage-tn.png",
        "265-5yh2_homepage-tn.png",
        "266-6s7o_homepage-tn.png",
        "267-5t89_homepage_new-tn.png",
        "268-Figure1_homepage-tn.png",
        "269-6pv7_homepage-tn.png",
        "270-4fxf_homepage-tn.png",
        "271-7lsy_homepage-tn.png",
        "272-3chn_6ue7_homepage-tn.png",
        "273-5xth_homepage-tn.png",
        "274-5hzg_homepage-tn.png",
        "275-7tpt_homepage-tn.png",
        "276-1q83_homepage-tn.png",
        "277-5xh3_6qga_homepage-tn.png",
        "278-nucleocapsid_homepage-tn.png",
        "279-5a31_homepage-tn.png",
        "280-7qpd_homepage-tn.png",
        "281-Cel7A_homepage-tn.png",
        "282-8f76_homepage-tn.png",
        "283-1opk_homepage-tn.png",
        "284-5np0_homepage-tn.png",
        "285-1t64_homepage-tn.png",
        "286-4jhw_3rrr_homepage-tn.png",
        "287-6j5t_homepage-tn.png",
        "288-3fpz_homepage-tn.png",
        "289-7enc_homepage-tn.png",
        "290-7qv7_homepage-tn.png",
        "291-2pe4_homepage-tn.png",
        "292-8g02_homepage-tn.png",
        "293-8eiq_homepage-tn.png",
        "294-7ah9_homepage-tn.png",
        "295-ribosomes_homepage-tn.png",
        "296-6tz4_homepage-tn.png",
        "297-BicA_homepage-tn.png",
        "298-2x0b_homepage-tn.png",
        "299-6e10_homepage-tn.png",
        "300-cw_homepage-tn.png",
        "301-Lsd14_nolabels-tn.png",
        "302-homepage-tn.png",
        "303-6OWE_lowRes-homepage-tn.png",
        "304-ApoB100_LDLR_cover-tn.png",
        "305-homepage_7vcf-tn.png",
        "306-homepage-tn.png",
        "307-homepage-tn.png",
        "308-6TAP_smaller-tn.png",
        "309-3JRS_homepage-tn.png",
        "310-incretins-tn.png",
        "311-agonists-tn.png",
...
//August 2020
    ...
    fun searchMotmInfo(searchTerm: String): List<MotmEntryInfo> {
        ...
        val mergeBothLists =
            (intArrayOf(*matchTag, *matchCorpus).sortedByDescending { it }).distinct()
