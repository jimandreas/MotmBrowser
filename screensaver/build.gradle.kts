...
android {
    ...
    defaultConfig {
        applicationId = "com.bammellab.screensaver"
        ...
        manifestPlaceholders["motmImageAuthority"] = motmImageAuthorityValue
        buildConfigField("String", "MOTMIMAGE_AUTHORITY", "\"$motmImageAuthorityValue\"")
    }
